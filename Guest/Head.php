        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg bg-white navbar-light py-2 py-lg-0">
                <a href="../index.php" class="navbar-brand">
                    <img class="img-fluid" src="../Assest/Templates/User/img/logo11.jpg" alt="Logo">
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto">
                        ...
                        <a href="Userregistration.php" class="nav-item nav-link">User Register</a>
                        <a href="Wastepickerregistration.php" class="nav-item nav-link">Waste Picker</a>
