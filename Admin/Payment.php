...
session_start();;
	if(isset($_POST["btn_pay"]))
	{
			   ...
			   $a = "UPDATE tbl_collectionhead SET collection_status = '1' WHERE collectionhead_id = '".$_SESSION['envid']."'";

				if(mysql_query($a))
				{					
					?>
					<script>
                       alert("Dear <?php echo $_SESSION["uname"] ?>, Your payment has been confirmed by eco recycle.");
...
<body>
	<div class="wrapper">
		...
		<form method="POST">
            ...
            <?php 
            $amount = isset($_GET['total']) ? htmlspecialchars($_GET['total']) : '0'; ?>
			<div class="input-group">
				<div class="input-box">
					<input class="name" type="text" readonly value="<?php echo $amount; ?>" name="txtamount" id="txtamount" required>
