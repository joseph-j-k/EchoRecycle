        ...
        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
            <thead>
                <tr>
                    ...
                    <th style="text-align:center">WastePicker</th>
			...
			<?php
			 ...
			 $i=0;
			 $selQry1 = "select * from  tbl_collectiondetails d inner join  tbl_wastetype w on w.wastetype_id = d.wastetype_id inner join tbl_unit u on u.unit_id = d.unit_id inner join tbl_rate r on r.rate_id = r.rate_id";
             $result1 = mysql_query($selQry1);



            $selQry2 = "select * from  tbl_collectionhead h inner join  tbl_wastepicker w on w.wastepicker_id = h.wastepicker_id inner join tbl_user u on u.user_id = h.user_id inner join tbl_ward wa on wa.ward_id = h.ward_id where collection_status > 0";
			 ...
			 {
				 $selQry = $selQry." and collection_date between '".$_POST["fdate"]."' and '".$_POST["tdate"]."'";
			 }
			 ...
			 if ($result1 && $result2) {
                   ...
                   while(($data1 = mysql_fetch_array($result1)) && ($data2 = mysql_fetch_array($result2))) 
				   {
					   ...
					   $amt = $data1["rate_amount"] * $data1["collectiondetails_qty"];
			...
			?>
              <tr>
                  ...
                  <td align="center"><img src="../Assest/File/user/<?php echo $data2["user_photo"]; ?>" style="height:100px; width:100px; border-radius:50px"/></td>
                 <td align="center"><?php echo $data2["user_name"]; ?></td>
                 <td align="center"><?php echo $data2["ward_no"]; ?></td>
                 <td align="center"><?php echo $data1["collectiondetails_qty"]; ?></td>
                 <td align="center"><?php echo $data1["rate_amount"]; ?></td>
                 <td align="center"><?php echo $data1["unit_qty"]; ?></td>
                 <td align="center"><?php echo $amt ?></td>
                 <td align="center"><?php echo $data2["wastepicker_name"]; ?></td>
                 <td align="center"><?php echo $data1["collection_date"]; ?></td>
              </tr>
               <?php
				}
            }
