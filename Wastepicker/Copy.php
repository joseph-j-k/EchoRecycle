...
$fetchQry2 = "SELECT MAX(collectiondetails_id) as max_id FROM  tbl_collectiondetails";
$result2 = mysql_query($fetchQry2);
...
if(isset($_POST['btnsubmit'])) {
    ...
    $insertHeadQry = "INSERT INTO tbl_collectionhead(ward_id, user_id, collectionhead_billno, collectionhead_date, collectionhead_totalamount, wastepicker_id, collectiondetails_id)
                      VALUES ('$wardId', '$userId', '$bill', '$date', '$grandTotal', '".$_SESSION["wid"]."', '".$headd."')";
...
<form id="form1" method="post">
  ...
  <table align="center" width="200" border="1">
    ...
    <tr>
      <td>Ward</td>
      <td><select name="selward" id="selward" onchange="getuser(this.value)">
    ...
    <tr>
      <td>User</td>
      <td><select name="seluser" id="seluser">
          <option>----Select---</option>
          <?php
  ...
  <table align="center" width="200" border="1">
    ...
    <?php 
        ...
        $selQry = "SELECT * FROM tbl_collectiondetails c 
                   ...
                   INNER JOIN tbl_rate r ON r.wastetype_id = c.wastetype_id inner join tbl_collectionhead h on h.collectiondetails_id = c.collectiondetails_id inner join bl_wastepicker p on p.wastepicker_id = h.wastepicker_id where p.wastepicker_id = '".$_SESSION["wid"]."'"; 
    ...
    <?php } ?>
    <tr>
      <td colspan="6" align="right"><label>Total</label>
        <input type="text" name="txttotal" id="txttotal" value="<?php echo $grandTotal; ?>" readonly /></td>
    </tr>
