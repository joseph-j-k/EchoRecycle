...
<h1 align="center">My Profile</h1>
  <?php 
  $sel = "select * from tbl_wastepicker u inner join tbl_ward w on w.ward_id = u.ward_id where u.wastepicker_id = '".$_SESSION["wid"]."'";
  $result = mysql_query($sel);
  $data = mysql_fetch_array($result);
  ?>
  <img src="../Assest/File/Wastepicker/<?php echo $data["wastepicker_photo"] ?>" width="400" height="250" class="img"/>
  <table align="center">
    <tr>
      <td>Name</td>
