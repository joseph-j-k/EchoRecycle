        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg bg-white navbar-light py-2 py-lg-0">
                <a href="HomePage.php" class="navbar-brand">
                    <img class="img-fluid" src="../Assest/Templates/User/img/logo.png" alt="Logo">
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto">
                        ...
                        <a href="Viewschedule.php" class="nav-item nav-link">View Schedule</a>
                        <a href="Complaint.php" class="nav-item nav-link">Complaint</a>
                        <a href="Feedback.php" class="nav-item nav-link">Feedback</a>
                        <a href="Recepit.php" class="nav-item nav-link">View Recepit</a>
